...
use App\Http\Requests\Api\Deal\Rules\ShowRequest;
use App\Http\Requests\Api\Deal\Rules\StoreRequest;
use App\Http\Resources\Api\Deal\RuleResource;
...
class RulesController extends Controller
{
    ...
    public function index(ShowRequest $request)
    {
        ...
        $rules = Rule::where('CRM_TYPE', 'CRM_DEAL')
...
//END
    ...
    public function updateblock(UpdateRequest $request, string $id)
    {
        ...
        $rules_block = Rule::where('CRM_TYPE', 'CRM_DEAL')
            ->where('member_id', $data['member_id'])
            ->where('block', $id)
            ->get();
