...
use App\Http\Requests\Api\Company\Rules\StoreRequest;
use App\Http\Requests\Api\Company\Rules\UpdateRequest;
use App\Http\Resources\Api\Company\RuleResource;
...
class RulesController extends Controller
{
    ...
    public function index(ShowRequest $request)
    {
        ...
        $rules = Rule::where('CRM_TYPE', 'CRM_COMPANY')
    ...
    public function updateblock(UpdateRequest $request, string $id)
    {
        ...
        $rules_block = Rule::where('CRM_TYPE', 'CRM_COMPANY')
            ->where('member_id', $data['member_id'])
            ->where('block', $id)
            ->get();
