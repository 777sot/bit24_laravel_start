...
use App\Http\Requests\Api\Quote\Fields\ShowRequest;
...
class FieldsController extends Controller
{
    ...
    public function index(ShowRequest $request)
    {
        ...
        $fields = Field::where('CRM_TYPE', 'CRM_QUOTE')->where('member_id', $data['member_id'])->get();
    ...
    public function update_index(Request $request)
    {
        ...
        $count_fields = Field::where('CRM_TYPE', "CRM_QUOTE")->count();
